...
if($temp <= 60) {
   echo 'It is a semi-warm day!';
    ...
    echo 'It may be getting warmmer!';
}
echo '<br>';
$new_temp = 81;
if($new_temp <= 60) {
...
if($sales <= 99999) {
echo 'Soryy, you did not make your bonus!';
} elseif($sales <=119999) {
$salary *= 1.05;
...
echo ' $'.number_format($salary, 2).' dollars  ';
    ...
    $salary *= 1.20;
    echo 'Awesome! You made 20% bobus!!! Your annual salary including bonus totals $'.number_format($salary, 2).' dollars  ';
}